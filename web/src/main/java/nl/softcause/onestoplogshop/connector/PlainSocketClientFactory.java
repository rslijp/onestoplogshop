...
public class PlainSocketClientFactory implements Runnable {
    private static final Logger logger = LoggerFactory.getLogger(PlainSocketClientFactory.class);
    ...
    // Constructor
    public PlainSocketClientFactory(int socketPort, LoggingEventPublisher publisher)
    {
    ...
    public void run()
    {
        ...
        try {
            ...
            while (true) {
                ...
                var clientSock
                        = new TextClientHandler(client, publisher);
